...
if (!isAdmin()) {
    echo json_encode(['success' => false, 'message' => 'Nur Administratoren können das Grid-Layout speichern.']);
    exit;
}
...
try {
    ...
    // Speichern der Grid-Konfiguration
    ...
    // Aktualisieren der Raumpositionen
